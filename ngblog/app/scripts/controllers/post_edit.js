...
angular.module('ngblogApp')
  .controller('PostEditCtrl', ['$scope', 'postsService', '$routeParams', '$location', 'FileUploader', 'adminNavService', function($scope, postsService, $routeParams, $location, FileUploader, adminNavService) {
    $scope.crumbs = [{
      anchor: '/#admin/posts',
      menu: '所有文章'
    }, {
